...
module OCaml = struct
  module F = Formats.OCaml (ExtensionDispatcherSubFormat)
...
module Tree (Params : sig val variants : bool val info : string end) = struct
  ...
  module F = Formats.Res (ExtensionDispatcherSubFormat)
  let options =
...
module Files = struct
  module F = Formats.Files (SubFormats.Raw)
